-- phpMyAdmin: выполнить целиком; при ошибке DELIMITER — под полем SQL задайте разделитель $$ и уберите строки DELIMITER.
-- Синхронизировано с ch_outside_premerge_open_duplicates.sql
